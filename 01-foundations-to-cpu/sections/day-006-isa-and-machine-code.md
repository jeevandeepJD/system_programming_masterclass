...
`01-foundations-to-cpu/challenges/day-006-machine-code-lab.c`
...
gcc -std=c17 -Wall -Wextra -Wpedantic -O2 -g \
  01-foundations-to-cpu/challenges/day-006-machine-code-lab.c -o /tmp/day6-gcc

clang -std=c17 -Wall -Wextra -Wpedantic -O2 -g \
  01-foundations-to-cpu/challenges/day-006-machine-code-lab.c -o /tmp/day6-clang
...
gcc -std=c17 -Wall -Wextra -Wpedantic -O0 -g \
  01-foundations-to-cpu/challenges/day-006-machine-code-lab.c -o /tmp/day6-gcc-O0
...
gcc -std=c17 -Wall -Wextra -Wpedantic -O2 -S \
  01-foundations-to-cpu/challenges/day-006-machine-code-lab.c -o /tmp/day6-gcc.s

clang -std=c17 -Wall -Wextra -Wpedantic -O2 -S \
  01-foundations-to-cpu/challenges/day-006-machine-code-lab.c -o /tmp/day6-clang.s
```
...
`01-foundations-to-cpu/challenges/day-006-fictional-isa.py`
...
```bash
python3 01-foundations-to-cpu/challenges/day-006-fictional-isa.py table

python3 01-foundations-to-cpu/challenges/day-006-fictional-isa.py \
  encode add r1 r2 r3

python3 01-foundations-to-cpu/challenges/day-006-fictional-isa.py \
  encode addi r1 r2 -5

python3 01-foundations-to-cpu/challenges/day-006-fictional-isa.py decode 0x1298

python3 01-foundations-to-cpu/challenges/day-006-fictional-isa.py repl
```
...
```bash
python3 01-foundations-to-cpu/challenges/day-006-fictional-isa.py encode addi r1 r2 31
python3 01-foundations-to-cpu/challenges/day-006-fictional-isa.py encode addi r1 r2 32
python3 01-foundations-to-cpu/challenges/day-006-fictional-isa.py encode addi r1 r2 -32
python3 01-foundations-to-cpu/challenges/day-006-fictional-isa.py encode addi r1 r2 -33
python3 01-foundations-to-cpu/challenges/day-006-fictional-isa.py encode jmp 2047
python3 01-foundations-to-cpu/challenges/day-006-fictional-isa.py encode jmp 2048
```
