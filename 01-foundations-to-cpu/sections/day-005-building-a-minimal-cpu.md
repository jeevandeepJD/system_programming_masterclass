...
`01-foundations-to-cpu/challenges/day-005-tiny-cpu.py`

First, predict the final values of `PC`, `IR`, `R0`, `R1`, and `MEM[0]`.
Then run the complete trace:

```bash
python3 01-foundations-to-cpu/challenges/day-005-tiny-cpu.py
```
...
```bash
python3 01-foundations-to-cpu/challenges/day-005-tiny-cpu.py --step
```
...
- Charles Petzold, *Code: The Hidden Language of Computer Hardware and
  ...
  `references/library/books/01-foundations-and-architecture/code-hidden-language-computer-hardware-software-charles-petzold.pdf`
