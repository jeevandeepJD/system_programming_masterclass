...
```bash
python3 03-c-toolchain-and-startup/challenges/day-005-object-lab.py
```
...
```bash
gcc -E 03-c-toolchain-and-startup/challenges/day-005-object-demo.c |
  less
gcc -S -O0 03-c-toolchain-and-startup/challenges/day-005-object-demo.c -o /tmp/demo.s
gcc -c -O0 03-c-toolchain-and-startup/challenges/day-005-object-demo.c -o /tmp/demo.o
