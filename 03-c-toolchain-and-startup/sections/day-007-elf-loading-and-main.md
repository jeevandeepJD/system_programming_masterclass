...
```bash
bash 03-c-toolchain-and-startup/challenges/day-007-elf-startup-lab.sh
```
...
- Kerrisk, *The Linux Programming Interface*, Chapter 6 and Chapter 27, for
  ...
  `references/library/books/02-os-and-linux/linux-programming-interface-michael-kerrisk.pdf`
