...
```text
03-c-toolchain-and-startup/sections/day-001-pointers-arrays-and-strings.md
```
...
```text
03-c-toolchain-and-startup/sections/day-002-structures-unions-and-function-pointers.md
```

Challenge:

```text
03-c-toolchain-and-startup/challenges/day-002-layout-callback-lab.c
```
...
```text
03-c-toolchain-and-startup/sections/day-003-dynamic-memory-and-lifetime.md
```
...
```text
03-c-toolchain-and-startup/sections/day-004-qualifiers-atomics-and-undefined-behavior.md
```

Challenges:

```text
03-c-toolchain-and-startup/challenges/day-004-qualifiers-ub-lab.c
03-c-toolchain-and-startup/challenges/day-004-atomics-lab.c
```
...
```text
03-c-toolchain-and-startup/sections/day-005-source-to-object-file.md
```

Challenges:

```text
03-c-toolchain-and-startup/challenges/day-005-object-demo.c
03-c-toolchain-and-startup/challenges/day-005-object-lab.py
```
...
```text
03-c-toolchain-and-startup/sections/day-006-linking-and-libraries.md
```

Challenge:

```text
03-c-toolchain-and-startup/challenges/day-006-linking-lab.sh
```
...
```text
03-c-toolchain-and-startup/sections/day-007-elf-loading-and-main.md
```

Challenges:

```text
03-c-toolchain-and-startup/challenges/day-007-startup-probe.c
03-c-toolchain-and-startup/challenges/day-007-elf-startup-lab.sh
```
