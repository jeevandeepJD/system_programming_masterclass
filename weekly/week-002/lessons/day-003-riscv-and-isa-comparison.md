...
```bash
python3 weekly/week-002/challenges/day-003-riscv-decoder.py demo
python3 weekly/week-002/challenges/day-003-riscv-decoder.py selftest
```
...
```bash
python3 weekly/week-002/challenges/day-003-riscv-decoder.py \
  fields 0x00b50633
```
...
```bash
python3 weekly/week-002/challenges/day-003-riscv-decoder.py decode \
...
```bash
python3 weekly/week-002/challenges/day-003-riscv-decoder.py exercise
```
...
```bash
python3 weekly/week-002/challenges/day-003-riscv-decoder.py trace branch
```
...
```bash
python3 weekly/week-002/challenges/day-003-riscv-decoder.py trace sum
```
...
```bash
python3 weekly/week-002/challenges/day-003-riscv-decoder.py decode 0x00000000
```
