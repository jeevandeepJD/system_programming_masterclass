...
```bash
cd 02-assembly-memory-and-c/challenges
...
- Bryant and O'Hallaron, *Computer Systems: A Programmer's Perspective*, 3rd
  ...
  `references/library/books/01-foundations-and-architecture/computer-systems-a-programmers-perspective-3rd-edition.pdf`
