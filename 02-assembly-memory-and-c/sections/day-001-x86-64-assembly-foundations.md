...
gcc -std=c17 -Wall -Wextra -O0 -S \
  02-assembly-memory-and-c/challenges/day-001-driver.c -o /tmp/day1-O0.s
gcc -std=c17 -Wall -Wextra -O2 -S \
  02-assembly-memory-and-c/challenges/day-001-driver.c -o /tmp/day1-O2.s
gcc -std=c17 -Wall -Wextra -O2 -g \
  02-assembly-memory-and-c/challenges/day-001-driver.c \
  02-assembly-memory-and-c/challenges/day-001-routines.s -o /tmp/day1-O2
