...
```text
02-assembly-memory-and-c/sections/day-001-x86-64-assembly-foundations.md
```

Challenges:

```text
02-assembly-memory-and-c/challenges/day-001-routines.s
02-assembly-memory-and-c/challenges/day-001-driver.c
```
...
```text
02-assembly-memory-and-c/sections/day-002-stack-frames-and-calling-conventions.md
```

Challenges:

```text
02-assembly-memory-and-c/challenges/day-002-stack-frames-lab.c
02-assembly-memory-and-c/challenges/day-002-abi-probe.s
```
...
```text
02-assembly-memory-and-c/sections/day-003-risc-v-assembly-and-isa-comparison.md
```
...
```text
02-assembly-memory-and-c/sections/day-004-ram-locality-and-memory-wall.md
```
...
02-assembly-memory-and-c/challenges/day-004-plot.py
```
...
```text
02-assembly-memory-and-c/sections/day-005-cache-organization.md
```

Challenge:

```text
02-assembly-memory-and-c/challenges/day-005-cache-lab.c
```
...
```text
02-assembly-memory-and-c/sections/day-006-alignment-endianness-and-numa.md
```

Challenges:

```text
02-assembly-memory-and-c/challenges/day-006-layout-endian-lab.c
02-assembly-memory-and-c/challenges/day-006-topology-probe.sh
```
...
```text
02-assembly-memory-and-c/sections/day-007-c-execution-model-and-data-types.md
```

Challenge:

```text
02-assembly-memory-and-c/challenges/day-007-c-machine-model-lab.c
```
